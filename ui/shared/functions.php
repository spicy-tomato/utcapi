<?php
    ...
    function shared_header (string $title, string $otherTags = '') : void
    {
        ...
        <head>
          ...
          <link rel="icon" href="' . $root_folder . '/ui/resources/logo.png">
          ...
          <div id="left-form">
            ...
            <div class="form-group mt-4">
              ...
              <span id="notice">*Nếu nội dung thông báo có đường dẫn tệp, 
                hãy thao tác trực tiếp ở phần đính kèm link bên dưới trong trường hợp muốn thêm hoặc xóa
                thay vì sửa trực tiếp ở phần nội dung.
            </span>
              <textarea cols="30" rows="10" class="form-control" id="content"></textarea>
            </div>
            <div class="form-group mt-4">
              <label for="attach-link"><legend>Đính kèm link: (Dán link ở dưới rồi nhấn Enter để xác nhận)</legend></label><br>
